  ...
  return (
    <>
      ...
      <div style={{ overflowX: "clip" }}>
        ...
        <a
          href="https://wa.me/916362013676?text=Hi%20Imran%2C%20I%20found%20your%20portfolio."
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Chat with me on WhatsApp"
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full transition-transform duration-300 hover:scale-110"
          style={{
        ...
        >
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.198.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371.074-.57.074-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.626.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z" />
            <path d="M20.52 3.449C18.24 1.172 15.21-.08 12.002-.08 5.373-.08-.02 5.31-.02 11.94c0 2.102.55 4.155 1.595 5.965L-.1 23.9l6.14-1.61a11.88 11.88 0 0 0 5.96 1.61h.005c6.628 0 12.02-5.39 12.02-12.02 0-3.21-1.25-6.23-3.505-8.43zM12.005 21.9h-.004a9.9 9.9 0 0 1-5.04-1.38l-.36-.214-3.64.955.972-3.55-.234-.364a9.9 9.9 0 0 1-1.52-5.26c0-5.47 4.45-9.92 9.93-9.92 2.65 0 5.14 1.03 7.01 2.9a9.85 9.85 0 0 1 2.91 7.02c-.01 5.47-4.46 9.91-9.92 9.91z" />
          </svg>
        </a>
